...
class ESM2:
    def __init__(self,
                 ...
                 _subfolder='conservation_and_distance/',
    ...
    def run_prediction_pipeline(self,
        ...
        self._dir = self.data_folder + self._subfolder + self.data_fbase + '/' + self.model_type + '-' + self.layer_str + '/'
        print('Conservation analysis dir:', self._dir)
