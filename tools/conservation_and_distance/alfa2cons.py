...
def parseArgs():
    ...
    try:
        ...
        parser.add_argument('msa_subfolder',
                            ...
                            required=False,
                            default='msa/')
        parser.add_argument('conservation_and_distance_subfolder',
                            '-con_dir',
                            action='store',
                            required=False,
                            default='conservation_and_distance/')
    except:
...
def main(args=None):
    ...
    if args is None:
        ...
        conservation_and_distance_subfolder = args.conservation_and_distance_subfolder
        msa_fname = args.msa_fname
        # derive input & out put fpaths
        msa_fpath = data_folder + msa_subfolder + msa_fname
        output_dir = data_folder + conservation_and_distance_subfolder
...
if __name__ == "__main__":
    args = {
        ...
        'msa_subfolder': 'msa/',
        'conservation_and_distance_subfolder': 'conservation_and_distance/',
